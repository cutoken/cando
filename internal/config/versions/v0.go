...
// ConfigV0 represents the config structure from main branch (pre-migration)
// This is the legacy format before we added versioning
// NOTE: Never store API keys or secrets in these structs or test data!
